...
<ul class="header-cart-wrapitem w-full">
  ...
  $total += $plan['cantidad'] * $plan['precio']; // suma lo que tiene total y ascede a cantidad
  $idPlan = openssl_encrypt($plan['id_plan'],METHODENCRIPT,KEY);
 
  ?>
<li class="header-cart-item flex-w flex-t m-b-12">
        <div class="header-cart-item-img" idpl="<?= $idPlan ?>" op="1" onclick="fntdelItem(this)">
        ...
        <div class="header-cart-item-txt p-t-8">
            ...
            <span class="header-cart-item-info">
                <?= $plan['cantidad'].' x '.SMONEY.formatMoney($plan['precio'])?>
            </span>
        </div>
    </li>
    <?php
