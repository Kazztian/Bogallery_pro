    ...
    public function getUsuarios()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            $arrData[$i]['options'] = '<div class="text-center">
                <button class="btn btn-outline-secondary btn-sm btnViewUsuario" us="' . $arrData[$i]['id_usuario'] . '"title="Ver Usuario"><i class="bi bi-key-fill"></i></button>

                <button class="btn btn-warning btn-sm btnEditUsuario"  us="' . $arrData[$i]['id_usuario'] . '" title="Editar Usuario"><i class="bi bi-pencil-square"></i></button>

                <button class="btn btn-danger btn-sm btnDelUsuario" us="' . $arrData[$i]['id_usuario'] . '" title="Eliminar"><i class="bi bi-trash"></i></button>
                </div>';
        }
